...
# Plot the reault of Dorminance analysis and partial correlation analysis in the daytime
...
def plot_meshgrid_pr(ax,df,var,vmin,vmax,xlabflag,ylabflag,ytext):#
    ...
    if ylabflag == False:
        ax.set_yticklabels([])
    ax.text(1.02, 0.20, ytext, transform=ax.transAxes, fontsize=12, rotation=270)  # , style='italic'
...
plot_meshgrid_da(  ax1,   dff_da, 'ETd', vmin, vmax,  False, True ,'')
plot_meshgrid_da(  ax2,   dfg_da, 'ETd', vmin, vmax,  False, False,'')
plot_meshgrid_da(  ax3,   dfu_da, 'ETd', vmin, vmax,  False, False,'')
plot_meshgrid_da(  ax7,   dff_da, 'ALd', vmin, vmax,  True,  True ,'')
plot_meshgrid_da(  ax8,   dfg_da, 'ALd', vmin, vmax,  True,  False,'')
c=plot_meshgrid_da(ax9,   dfu_da, 'ALd', vmin, vmax,True,  False,'')
...
# ####################################
vmin, vmax = -0.8,0.8
plot_meshgrid_pr(  ax4,   dff_pr, 'ETd', vmin, vmax,  False, False ,'')
plot_meshgrid_pr(  ax5,   dfg_pr, 'ETd', vmin, vmax,  False, False,'')
plot_meshgrid_pr(  ax6,   dfu_pr, 'ETd', vmin, vmax,  False, False,'ET vs. LST')
plot_meshgrid_pr(  ax10,  dff_pr, 'ALd', vmin, vmax,  True,  False ,'')
plot_meshgrid_pr(  ax11,  dfg_pr, 'ALd', vmin, vmax,  True,  False,'')
c=plot_meshgrid_pr(ax12,  dfu_pr, 'ALd', vmin, vmax,  True,  False,'Albedo vs. LST')
